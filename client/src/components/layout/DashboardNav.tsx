// Planexa — DashboardNav
// Design: Slate-dark (#1E293B) background, Fraunces logo, forest green accent
// Navigation bar with logo, nav links, + New Appointment button, user avatar
...
export default function DashboardNav() {
  ...
  return (
    <>
            ...
            return (
              <Link
                ...
                style={{
                  ...
                  backgroundColor: isActive ? 'rgba(82, 183, 136, 0.1)' : 'transparent',
                }}
              >
                {label}
              </Link>
      ...
      {mobileOpen && (
        <div
          className="fixed top-14 left-0 right-0 z-40 md:hidden py-2"
